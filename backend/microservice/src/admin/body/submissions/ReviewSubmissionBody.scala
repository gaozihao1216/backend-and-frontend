package microservice.admin.body.submissions
...
/** ReviewSubmissionBody 的 Circe/http4s 编解码 companion。 */
private[admin] object ReviewSubmissionBody {
