...
} from "../bird/bird-pool-session.js";
import {
  DEFAULT_BIRD_DEFINITION,
  listSystemBirdDefinitions,
  type BirdDefinition,
} from "../bird/bird-definition.js";
...
import type { GameBody, GameSession, GameSnapshot } from "../core/types.js";
import type { LevelData } from "../../../objects/level/level/level-data.js";
import { getGroundSurfaceYAtX, getLevelGround, getLevelTerrain, sampleBoundaryPathSegments, sampleGroundPath } from "../../../level/function/ground.js";
