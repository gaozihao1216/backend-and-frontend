...
import { createBlockDamageVisuals } from "../combat/crack-generator.js";
import { DEFAULT_BLOCK_MATERIAL, MATERIAL_PARAMS } from "../combat/materials.js";
import type { BlockGameEntity, GameBody, GameBodyKind, ObstacleMaterial } from "../core/types.js";
...
export const PENETRATION_CORRECTION_DYNAMIC_MAX_SPEED = 0.55;
export const RESTING_MICRO_SPEED = 0.22;
export const RESTING_SNAP_SPEED = 0.045;
export const RESTING_CONTACT_NORMAL_SPEED_THRESHOLD = 0.28;
export const RESTING_CONTACT_MICRO_SPEED_THRESHOLD = 0.09;
export const RESTING_CONTACT_TANGENTIAL_DAMPING = 0.82;
export const RESTING_CONTACT_MICRO_TANGENTIAL_DAMPING = 0.68;
...
export const BLOCK_SUPPORT_MICRO_NORMAL_SPEED_THRESHOLD = 0.11;
...
export const PIG_SUPPORT_MICRO_NORMAL_SPEED_THRESHOLD = 0.12;
