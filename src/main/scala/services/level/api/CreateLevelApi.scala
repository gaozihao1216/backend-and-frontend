package coursebackend.services.level.api

import cats.effect.IO
import coursebackend.HttpError
import coursebackend.services.level.objects.{Level, LevelData}
import coursebackend.services.system.objects.LevelTag
